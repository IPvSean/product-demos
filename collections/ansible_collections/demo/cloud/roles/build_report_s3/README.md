...
- ansible-core >= 2.16.0
- Target: `localhost`
- `amazon.aws` collection (`aws_caller_info`, `s3_bucket`, `s3_bucket_info`, `s3_object`, `s3_object_info`)
...
| `reports_aws_region` | `us-east-1` | Requested AWS region when creating a new bucket |
